<template>
  <div class="space-y-6">
    ...
    <p class="text-gray-900 dark:text-gray-400">
      I'm Salhe, I work as a Full Stack  Developer, product engineer and designer from 
      Addis Ababa, Ethiopia. I specialize in building web applications and sites
...
useSeoMeta({
  title: "Salhe Seid",
  description:
    "I'm Salhe, your friendly neighborhood software, product engineer and designer from Addis Ababa, Ethiopia. I specialize in building web applications and sites using Javascript, React, Vue & Node.",
});
</script>
